...
M.nmap({ '<leader>1', function() ui.nav_file(1) end, { silent = true } })
M.nmap({ '<leader>2', function() ui.nav_file(2) end, { silent = true } })
M.nmap({ '<leader>3', function() ui.nav_file(3) end, { silent = true } })
